...
export class CreateVendorsAndBuyersTable1711509407528 implements MigrationInterface {
    name = 'CreateVendorsAndBuyersTable1711509407528'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`vendors_and_buyers\` (\`id\` varchar(36) NOT NULL, \`person_type\` enum ('Pessoa Física', 'Pessoa Jurídica') NOT NULL, \`cnpj\` varchar(255) NULL, \`cpf\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`mobile_phone\` varchar(11) NOT NULL, \`telephone\` varchar(10) NOT NULL, \`email\` varchar(255) NOT NULL, \`cep\` varchar(8) NOT NULL, \`street\` varchar(255) NOT NULL, \`number\` varchar(255) NOT NULL, \`complement\` varchar(255) NULL, \`neighborhood\` varchar(255) NOT NULL, \`city\` varchar(255) NOT NULL, \`state\` varchar(255) NOT NULL, \`user_id\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
